...
$(document).on 'click', '.club-movies-link', ->
  masonryLoad('#masonry-container-club-movies')
	
$(document).on 'click', '.club-reviews-link', ->
  masonryLoad('#masonry-container-club-reviews')
